...
<p>solveTech is a Tech Support Platform, where issues with automation tools and utilities can be reported. This allows more systematic approach to resolving ang keeping history of submitted requests.</p>
...
<p>Admin Dashboard has graphs linked to requests, users and departments
...
<p>Admin panel contains of Management of Users, Departments and Roles:
...
<p>View request page from superuser:
...
<p>View request from regular user:
...
<p>Home page of regular user contains all their requests in a table. There is a header with search per status, title, ID or time of submission
